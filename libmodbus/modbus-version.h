...
#define LIBMODBUS_VERSION_MAJOR 3//(@LIBMODBUS_VERSION_MAJOR@)

/* The minor version (2, if %LIBMODBUS_VERSION is 1.2.3) */
#define LIBMODBUS_VERSION_MINOR 1//(@LIBMODBUS_VERSION_MINOR@)

/* The micro version (3, if %LIBMODBUS_VERSION is 1.2.3) */
#define LIBMODBUS_VERSION_MICRO 6//(@LIBMODBUS_VERSION_MICRO@)
